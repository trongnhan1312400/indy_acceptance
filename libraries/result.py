...
class TestResult:
    ...
    def __init__(self, test_case_name):
        ...
        self.__test_result[START_TIME] = str(time.strftime("%Y-%m-%d_%H-%M-%S"))
        self.__json_file_path = "{}{}_{}.json".format(TestResult.__json_dir, self.__test_result[TEST_CASE],
    ...
    def add_step(self, step):
        ...
        if not step:
            return
        temp = {STEP: step.get_name(), STATUS: step.get_status(), MESSAGE: step.get_message()}
        self.__run.append(temp)
