...
class SpecialCaseTrustAnchorRole(TestScenarioBase):
    ...
    async def execute_test_steps(self):
        ...
        await perform(self.steps, common.build_and_send_nym_request, self.pool_handle, self.wallet_handle,
                      default_trustee_did, trustee1_did, trustee1_verkey, None, Role.TRUSTEE)
        ...
        await perform(self.steps, common.build_and_send_nym_request, self.pool_handle, self.wallet_handle,
                      default_trustee_did, trustanchor1_did, trustanchor1_verkey, None, Role.TRUST_ANCHOR)
        ...
        await perform_with_expected_code(self.steps, common.build_and_send_nym_request, self.pool_handle,
                                         ...
                                         None, Role.TRUSTEE, expected_code=304)
        ...
        await perform_with_expected_code(self.steps, common.build_and_send_nym_request, self.pool_handle,
                                         ...
                                         None, Role.NONE, expected_code=304)
        ...
        await perform(self.steps, common.build_and_send_nym_request, self.pool_handle, self.wallet_handle,
                      trustee1_did, trustee2_did, trustee2_verkey, None, Role.TRUSTEE)
        ...
        await perform(self.steps, common.build_and_send_nym_request, self.pool_handle, self.wallet_handle,
                      trustee1_did, steward1_did, steward1_verkey, None, Role.STEWARD)
        ...
        await perform_with_expected_code(self.steps, common.build_and_send_nym_request, self.pool_handle,
                                         ...
                                         steward1_verkey, None, Role.NONE, expected_code=304)
        ...
        await perform_with_expected_code(self.steps, common.build_and_send_nym_request, self.pool_handle,
                                         ...
                                         trustanchor3_verkey, None, Role.TRUST_ANCHOR, expected_code=304)

        # 16. Using the Trustee1 create TrustAnchor2 -----------------------------------------------------------------
        self.steps.add_step("Using the Trustee1 create Steward1")
        await perform(self.steps, common.build_and_send_nym_request, self.pool_handle, self.wallet_handle,
                      trustee1_did, trustanchor2_did, trustanchor2_verkey, None, Role.TRUST_ANCHOR)
        ...
        await perform_with_expected_code(self.steps, common.build_and_send_nym_request, self.pool_handle,
                                         ...
                                         trustanchor2_verkey, None, Role.NONE, expected_code=304)
